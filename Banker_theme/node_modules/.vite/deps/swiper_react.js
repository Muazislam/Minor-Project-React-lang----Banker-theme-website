import { C as setInnerHTML, S as setCSSProperty, _ as getTranslate, a as elementIndex, b as nextTick, d as elementPrevAll, f as elementStyle, i as elementChildren, l as elementOuterSize, m as extend$1, n as createElement, o as elementIsChildOf, r as deleteProps, s as elementNextAll, u as elementParents, w as showWarning, x as now } from "./utils-wLBnKuvr.js";
...
*/
var SwiperSlideContext = createContext(null);
var useSwiperSlide = () => useContext(SwiperSlideContext);
var SwiperContext = createContext(null);
var useSwiper = () => useContext(SwiperContext);
...
var Swiper = forwardRef(function Swiper(propsArg, externalElRef) {
	...
	return React.createElement(TagComponent, {
		...
		...restProps
	}, React.createElement(SwiperContext.Provider, { value: swiperRef.current }, slots["container-start"], React.createElement(WrapperComponent, { className: wrapperClass(swiperParams.wrapperClass) }, slots["wrapper-start"], renderSlides(), slots["wrapper-end"]), needsNavigation(swiperParams) && React.createElement(React.Fragment, null, React.createElement("div", {
		ref: prevElRef,
...
var SwiperSlide = forwardRef(function SwiperSlide(props, externalRef) {
	...
	return React.createElement(TagComponent, {
		...
		onLoad,
		...rest
	}, zoom && React.createElement(SwiperSlideContext.Provider, { value: slideData }, React.createElement("div", {
		className: "swiper-zoom-container",
		"data-swiper-zoom": typeof zoom === "number" ? zoom : void 0
	}, renderChildren(), lazy && !lazyLoaded && React.createElement("div", {
		className: "swiper-lazy-preloader",
		ref: lazyPreloaderRef
	}))), !zoom && React.createElement(SwiperSlideContext.Provider, { value: slideData }, renderChildren(), lazy && !lazyLoaded && React.createElement("div", {
		className: "swiper-lazy-preloader",
		ref: lazyPreloaderRef
	})));
});
